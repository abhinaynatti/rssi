...
//        uniqueId1 = "164ba8e2-8aa0-4125-bf71-966d910e9e1e";
        uniqueId2 =  "f5e70cac-60ef-4e5c-be90-d4f0dcded9d5";
        Log.v("UUID",uniqueId2);
//        UUID one_UUID = UUID.fromString(uniqueId1);
        UUID two_UUID = UUID.fromString(uniqueId2);
        ParcelUuid parcelUuid = new ParcelUuid(SERVICE_UUID);

//        ParcelUuid parcelUuid = new ParcelUuid(one_UUID);
//        ParcelUuid parcelUuid = new ParcelUuid(two_UUID);
        String device_name = "note10";

        byte[] extra_data = device_name.getBytes(StandardCharsets.UTF_8);
//        String check_string = new String(extra_data,StandardCharsets.UTF_16);
//        Log.v("check_bytes","the string is " + check_string);

        AdvertiseData data = new AdvertiseData.Builder()
//                .addManufacturerData(0,extra_data)
