...
//                + "\nReceived: " + StringUtils.byteArrayInHexFormat(value));
        String message = StringUtils.stringFromBytes(value);
        mServerActionListener.log("Received:" + message);
        ...
        if (CHARACTERISTIC_ECHO_UUID.equals(characteristic.getUuid())) {
            ...
            String reverseMessage = StringUtils.stringFromBytes(response);
            mServerActionListener.log("Sending:" + reverseMessage);
